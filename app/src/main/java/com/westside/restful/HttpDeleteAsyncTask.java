 ...
 */
public class HttpDeleteAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public HttpDeleteAsyncTask(String http, AsyncEventHandler eventHandler, int message, Map<String, Object> headerParams, String payload) {
        this.http = http;
